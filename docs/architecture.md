...
| `HasTelemetryMeta` | Vertex | `type_name`, `migration_file`, `change_type`, `applied_at` | — | Auto-generated by lineage hook |
...
| `Performed` | Edge | `occurred_at` | — | Migration |
